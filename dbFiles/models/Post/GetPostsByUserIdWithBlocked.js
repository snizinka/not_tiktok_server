...
class GetPostsByUserIdWithBlocked extends Post {
    static async getPosts(id) {
        ...
        FROM nottiktok.post as pt LEFT JOIN nottiktok.users as us ON us.userId = pt.userId 
        WHERE pt.userId = ${id}`;
  ...
  module.exports = GetPostsByUserIdWithBlocked;